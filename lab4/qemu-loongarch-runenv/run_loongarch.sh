...
DEBUG=''
HOST_ARCH=$(uname -m)
QEMU="/home/baiziyao/Desktop/qemu/bulid4la/qemu-system-loongarch64"
LA_EMU="/home/baiziyao/Desktop/LA_EMU/build/la_emu_kernel"
# Get the options
...
set -x
 $QEMU -m $MEM -smp $CPUS -kernel $KERNEL -d in_asm,mmu -D log.log -append "$CMDLINE" $GRAPHIC $DEBUG

#$LA_EMU -w -z -n -m $MEM -k $KERNEL 
